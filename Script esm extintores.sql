...
FOR EACH ROW
BEGIN
    INSERT INTO log_empresa (chave_primaria, acao)
...
FOR EACH ROW
BEGIN
    INSERT INTO log_funcionario (chave_primaria, acao)
...
FOR EACH ROW
BEGIN
    INSERT INTO log_cliente (chave_primaria, acao)
...
FOR EACH ROW
BEGIN
    INSERT INTO log_manutencao (chave_primaria, acao)
...
FOR EACH ROW
BEGIN
    INSERT INTO log_comercial (chave_primaria, acao)
    VALUES (NEW.CNPJ, 'INSERIDO');
END;
//
DELIMITER ;
...
FOR EACH ROW
BEGIN
    INSERT INTO log_residencial (chave_primaria, acao)
    VALUES (NEW.CNPJ, 'INSERIDO');
END;
//
DELIMITER ;
...
FOR EACH ROW
BEGIN
    INSERT INTO log_balcao (chave_primaria, acao)
    VALUES (NEW.CNPJ, 'INSERIDO');
END;
//
DELIMITER ;
...
FOR EACH ROW
BEGIN
    INSERT INTO log_requisita (chave_primaria, acao)
...
FOR EACH ROW
BEGIN
    INSERT INTO log_industrial (chave_primaria, acao)
    VALUES (NEW.CNPJ, 'INSERIDO');
END;
//
DELIMITER ;
